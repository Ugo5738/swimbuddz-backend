...
from services.communications_service.models import ContentPost, ContentComment, AnnouncementComment
from services.communications_service.schemas import (
    ContentPostCreate, ContentPostUpdate, ContentPostResponse,
    CommentCreate, ContentCommentResponse, AnnouncementCommentResponse
)
...
@content_router.post("/{post_id}/comments", response_model=ContentCommentResponse, status_code=201)
...
async def list_content_comments(
    ...
    query = select(ContentComment).where(
...
@router.post("/{announcement_id}/comments", response_model=AnnouncementCommentResponse, status_code=201)
...
@router.get("/{announcement_id}/comments", response_model=List[AnnouncementCommentResponse])
