...
# Register minimal referenced tables so FKs resolve during autogenerate ordering
Table(
    "sessions",
    target_metadata,
...
# Override URL from settings (double % for Alembic interpolation)
...
def run_migrations_offline() -> None:
    ...
    context.configure(
        ...
        version_table="alembic_version_attendance",
