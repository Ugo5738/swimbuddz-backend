...
@pytest.mark.asyncio
async def test_create_pending_registration(client: AsyncClient, db_session: AsyncSession):
    payload = {
...
@pytest.mark.asyncio
async def test_complete_pending_registration(client: AsyncClient, db_session: AsyncSession):
...
@pytest.mark.asyncio
async def test_get_current_member_profile(client: AsyncClient, db_session: AsyncSession):
