...
Revision ID: daf2598b2c03
Revises: 
Create Date: 2026-02-05 04:21:35.058172
"""
...
def upgrade() -> None:
    ...
    sa.Column('learn_to_swim_grade', sa.String(), nullable=True),
    sa.Column('special_populations_grade', sa.String(), nullable=True),
    sa.Column('institutional_grade', sa.String(), nullable=True),
    sa.Column('competitive_elite_grade', sa.String(), nullable=True),
    sa.Column('certifications_grade', sa.String(), nullable=True),
    sa.Column('specialized_disciplines_grade', sa.String(), nullable=True),
    sa.Column('adjacent_services_grade', sa.String(), nullable=True),
    sa.Column('total_coaching_hours', sa.Integer(), server_default='0', nullable=False),
    sa.Column('cohorts_completed', sa.Integer(), server_default='0', nullable=False),
    sa.Column('average_feedback_rating', sa.Float(), nullable=True),
    sa.Column('swimbuddz_level', sa.Integer(), nullable=True),
    sa.Column('last_active_date', sa.Date(), nullable=True),
    sa.Column('first_aid_cert_expiry', sa.Date(), nullable=True),
