...
# Can be run independently or called from db/reset.sh
#
# Usage:
...
SEED_TASKS=(
  "program.py|--file scripts/seed-data/freestyle_beginner.json:Seed Beginner Program"
  "discounts.py|:Seed Discount Codes"
  "content-posts.py|:Seed Content Posts"
  "announcements.py|:Seed Announcements"
  "agreement.py|:Seed Coach Agreement Version"
  "chat_safeguarding.py|:Seed Chat Safeguarding Policy Version"
