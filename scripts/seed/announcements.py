...
Usage:
    python scripts/seed/announcements.py

Note: Requires an admin member to exist in the database (run auth/create-admin.py first).
"""
...
async def seed_announcements():
    ...
    json_path = Path(__file__).parent.parent / "seed-data" / "announcements.json"
