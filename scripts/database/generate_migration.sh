...
#
# Usage:
#   ./scripts/database/generate_migration.sh <service> "<description>"
#   ./scripts/database/generate_migration.sh members_service "add phone field"
#   ./scripts/database/generate_migration.sh --all "add audit fields"
#
# After generating:
#   1. Review the generated migration file
#   2. Test locally with: ./scripts/database/reset_db.sh dev
...
echo "2. Test locally:"
echo "   ./scripts/database/reset_db.sh dev"
echo ""
